package com.example.spring.surveymonkey.config;
...
import com.example.spring.surveymonkey.oauth.service.SurveymonkeyUserService;
import com.example.spring.surveymonkey.oauth.token.AccessTokenResponseClient;
...
public class SecurityConfiguig
	...
	private DelegatingOAuth2UserService<OAuth2UserRequest, OAuth2User> userService() {
		...
		// Surveymonkey 専用
		userServices.add(new SurveymonkeyUserService());
